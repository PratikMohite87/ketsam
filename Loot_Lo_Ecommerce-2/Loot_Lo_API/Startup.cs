...
namespace Loot_Lo_API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<LootLoDbContext>(Options => Options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));

            services.AddScoped<ICustomerRepository, CustomerRepository>();
            services.AddScoped<ICustomerOrderDetailsRepository, CustomerOrderDetailsRepository>();
            services.AddScoped<IOrderedProductQuantityRepository, OrderedProductQuantityRepository>();
